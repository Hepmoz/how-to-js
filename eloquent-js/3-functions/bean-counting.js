 ...
 * The first character has position 0, which causes the last one to be found 
 ...
 * there are in the string. Next, write a function called countChar that 
 * behaves like countBs, except it takes a second argument that indicates 
